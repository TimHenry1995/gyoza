...
[![Video Title]([https://img.youtube.com/vi/VIDEO_ID/0.jpg](https://github.com/TimHenry1995/gyoza/blob/main/docs/Inference%20on%20Arc.png?raw=true))]([https://www.youtube.com/watch?v=VIDEO_ID](https://www.youtube.com/watch?v=j-tYR6tvtb0))
## Installation
```
pip install gyoza
```
