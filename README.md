...
[![Watch the video]([https://i.sstatic.net/Vp2cE.png](https://github.com/TimHenry1995/gyoza/blob/main/docs/Inference%20on%20Arc.png?raw=true))]([https://youtu.be/vt5fpE0bzSY](https://github.com/TimHenry1995/gyoza/blob/main/docs/Inverse%20Modelling.mp4))
## Installation
```
pip install gyoza
```
