...
class TestAdditiveCoupling(unittest.TestCase):
    ...
    def test_init_1_dimensional(self):
        ...
        mfl.AdditiveCoupling(axes=[0], shape=[5], compute_coupling_parameters=compute_coupling_parameters, mask=mask)
    ...
    def test_init_2_dimensional(self):
        ...
        mfl.AdditiveCoupling(axes=[0,1], shape=[2,5],compute_coupling_parameters=compute_coupling_parameters, mask=mask)
    ...
    def test_call_triangular_jacobian_1_dimensional_input_heaviside_mask(self):
        """Tests whether the call method of AdditiveCoupling produces a triangular jacobian on 1-dimensional inputs."""
        ...
        layer = mfl.AdditiveCoupling(axes=[0], shape=[5], compute_coupling_parameters=compute_coupling_parameters, mask=mask)
    ...
    def test_call_triangular_jacobian_2_dimensional_input_square_wave_2_d_mask(self):
        ...
        layer = mfl.AdditiveCoupling(axes=[0,1], shape=[2,7], compute_coupling_parameters=compute_coupling_parameters, mask=mask)
        x = tf.reshape(tf.range(14,dtype=tf.float32), [2,7])
...
class TestShuffle(unittest.TestCase):
    ...
    def test_call_and_inverse_2D_input_along_2_axes(self):
        """Tests whether the inverse method is indeed providing the inverse of the call on a 2D input along both axes."""
        
        # Initialize
        width = 4; height = 5
        shuffling_layer = mfl.Shuffle(shape=[width, height], axes=[0,1])
        x = tf.random.uniform(shape=[width, height], dtype=tf.float32)
